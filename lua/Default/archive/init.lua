require("lze").load({
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>ls", function() require("telescope.builtin").lsp_document_symbols(require("telescope.themes").get_cursor()) end, desc = "Document symbols"},
      { "<leader>lw", function() require("telescope.builtin").lsp_workspace_symbols(require("telescope.themes").get_cursor()) end, desc = "Workspace symbols"},
      { "<leader>lr", function() require('telescope.builtin').lsp_references(require('telescope.themes').get_cursor()) end, desc = "References"},
      { "<leader>ld", function() require("telescope.buildin").diagnostics(require('telescope.themes').get_ivy()) end, desc = "Diagnostics"},
